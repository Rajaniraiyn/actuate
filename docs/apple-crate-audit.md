...
These are architecture recommendations. None of the candidates has been compiled or benchmarked in Unimation during this review. A safe public Rust API reduces local FFI code, but does not prove compatibility, complete thread safety or better performance.

...
///
/// ```compile_fail
/// let mut backend = unimation::Backend::new(());
/// // No TouchInput implementation exists for Unavailable.
/// unimation::TouchInput::touch(&mut backend, unimation::TouchAction::Tap {
///     point: unimation::NormalizedPoint::new(0.5, 0.5).unwrap()
/// });
/// ```
